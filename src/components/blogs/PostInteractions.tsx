...
const PostInteractions = ({ post, isSmall, className }: PostInteractionsPropsType) => {
    ...
    return (
        <div className={`flex items-center ${isSmall ? "gap-x-1" : "gap-x-4"} ${className}`}>
            ...
            <button className={`p-[2px] bg-red-200 text-xs duration-150 text-red-600 hover:bg-red-600 hover:text-red-200 flex items-center gap-1 rounded`}>
                {post.isLiked
            ...
            <button className={`p-[2px] bg-blue-200 text-xs duration-150 text-blue-600 hover:bg-blue-600 hover:text-blue-200 flex items-center gap-1 rounded`}>
                {post.isBookmarked
